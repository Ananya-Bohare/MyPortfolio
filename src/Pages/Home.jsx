        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-lg-6">
            <div className="welcome">
              ...
              {[
                "I craft innovative solutions and bring ideas to life through code.",
                "Passionate about building seamless user experiences across web and mobile platforms."
              ].map((text, index) => (
                <motion.p
                  key={index}
                  variants={welcomeTitle}
              ...
              <div className="d-flex gap-3 mt-4 btn-container justify-content-lg-start justify-content-center align-items-center">
                <motion.a
                  ...
                  exit={{ x: "-100%", opacity: 0 }}
                  href="https://drive.google.com/uc?export=download&id=1nBhZ60CEoUBjx7dmb9CsFBVEUisvscj3"
                >
